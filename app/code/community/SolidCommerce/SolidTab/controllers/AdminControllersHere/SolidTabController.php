...
class SolidCommerce_SolidTab_AdminControllersHere_SolidTabController extends Mage_Adminhtml_Controller_Action
{
	public function indexAction()
	{
		...
		$block = $this->getLayout()->createBlock(
			...
			'SolidCommerce_SolidTab_Block',
			array('template' => 'solidcommerce/sc_inventory.phtml')
		);
